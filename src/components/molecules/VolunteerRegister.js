          ...
          <>
            ...
            <div className="col-xs-12 ">
              ...
              <div className="col-xs-12">
                <h2>Address</h2>
                <p>
                  You must select the address from the list that is generated
                  when you start typing. If your address is not present in the
                  list, try ommiting your flat number.
                </p>
                <PlacesAutocomplete
                  value={data.address}
