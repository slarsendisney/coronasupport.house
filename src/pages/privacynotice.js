...
import SEO from "../../../sld-prototype/src/components/seo";
...
export default () => (
  <div className="is-dark-blue">
    ...
    <div className="row container">
      <div>
        <h1>Privacy Policy for coronasupport.house</h1>
        <p>
          At coronasupport.house, accessible from coronasupport.house, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by coronasupport.house and how we use it.
        </p>
      ...
      <div>
        ...
        <p>
          coronasupport.house legal basis for collecting and using the personal
        ...
        <ul>
          <li>coronasupport.house needs to perform a contract with you</li>
          <li>You have given coronasupport.house permission to do so</li>
          <li>
            Processing your personal information is in coronasupport.house
            legitimate interests
          </li>
          <li>coronasupport.house needs to comply with the law</li>
        </ul>

        <p>
          coronasupport.house will retain your personal information only for as
        ...
        <p>
          coronasupport.house follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, coronasupport.house uses 'cookies'. These
        ...
        <p>
          ...
          advertising partners of coronasupport.house.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on coronasupport.house, which are
        ...
        <p>
          Note that coronasupport.house has no access to or control over these
        ...
        <p>
          coronasupport.house's Privacy Policy does not apply to other
        ...
        <p>
          coronasupport.house does not knowingly collect any Personal
        ...
        <p>
          ...
          shared and/or collect in coronasupport.house. This policy is not
